...
$(document).ready(function() {
    ...
    for (var i = 0; i < form.length; i++){
        ...
        if(form[i].line_paragraph){
            ...
            console.log ("Line Paragrap"+ text(lineParagraph));	
...
var zfValidatorFooter = function zfFooter (){
    var file =
	        ttt + "return $inputFilter;" + "<br>" +
            tt + "} <br>" +
            tt + "return $inputFilter;" + "<br>" +
        t + "} <br>" +
    '} <br>';
...
var textValidator = function textValidator (lineText, val){
    ...
    var textForm =
    tt + "$inputFilter->add($factory->createInput(array( <br>" +
        ttt + "'name' => '" + lineText.name + "', <br>" +
        hasRequired +
